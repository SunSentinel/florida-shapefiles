...
function getcomputeddisplay(elem) {
    ...
    <div class="md-subtitle">
      ...
      <xsl:for-each select="/metadata/idinfo/natvform[normalize-space(.) != '']">
        ...
        <xsl:if test="/metadata/spdoinfo/rastinfo/rastifor[normalize-space(.) != '']">
				- <xsl:value-of select="/metadata/spdoinfo/rastinfo/rastifor" /></xsl:if>
        <!-- ESRI Profile element -->
        <xsl:if test="/metadata/idinfo/citation/citeinfo/ftname[normalize-space(.) != '']">
				- <xsl:value-of select="/metadata/idinfo/citation/citeinfo/ftname" /></xsl:if>
      </xsl:for-each>
    </div>
    <!-- Build subtitle -->
    <div class="md-subtitle">FGDC<xsl:text></xsl:text><!-- Add ESRI to subtitle --><xsl:if test="/metadata/Esri"><xsl:text>, ESRI</xsl:text></xsl:if><!-- Add Biological to subtitle --><xsl:if test="/metadata/idinfo/spdom/boundalt or /metadata/distinfo/digform/asciistr or /metadata/idinfo/taxonomy or /metadata/idinfo/tool or /metadata/dataqual/lineage/method or /metadata/idinfo/timeperd/timeinfo/sngdate/geolage or /metadata/idinfo/timeperd/timeinfo/rngdates/beggeol/geolage or /metadata/idinfo/timeperd/timeinfo/rngdates/endgeol/geolage"><xsl:text>, Biological</xsl:text></xsl:if><xsl:if test="/metadata/dataqual/tidinfo or /metadata/dataqual/marweat or /metadata/dataqual/event"><xsl:text>, Shoreline</xsl:text></xsl:if><xsl:text></xsl:text>Metadata</div>
    <!-- Toggle definitions -->
  ...
  <xsl:template name="footer">
    <div class="md-footer">
      <a target="viewer">
        <xsl:attribute name="href">http://www.fgdc.gov/</xsl:attribute>Federal Geographic Data Committee</a>
    </div>
  </xsl:template>
  <!-- Thumbnail -->
              ...
              <table class="md-grid">
                ...
                <xsl:for-each select="northbc[normalize-space(.) != '']">
                  <tr>
                    <td>North</td>
                    <td>
                      <xsl:value-of select="." /> (latitude)</td>
                  </tr>
                </xsl:for-each>
        ...
        <xsl:if test="minalti[normalize-space(.) != ''] or maxalti[normalize-space(.) != ''] or altunits[normalize-space(.) != '']">
          ...
          <div class="md-itemhide">
            ...
            <xsl:for-each select="altunits[normalize-space(.) != '']">
              <div class="md">
                <b>Altitude units: </b>&gt;<xsl:value-of select="." /></div>
            </xsl:for-each>
          </div>
        </xsl:if>
        <!-- ESRI Profile element -->
  ...
  <xsl:template name="browse_graphic">
    ...
    <div class="md-detailhide">
      ...
      <xsl:for-each select="/metadata/idinfo/browse[browsen[normalize-space(.) != ''] or browsed[normalize-space(.) != ''] or browset[normalize-space(.) != '']]">
        ...
        <div class="md">
          <b>Browse graphic <xsl:number value="position()" format="1" /></b>
        </div>
        <div class="md-indent">
          <xsl:choose>
...
features in many feature classes in a geodatabase.</div>
        ...
        <xsl:if test="elemcls[normalize-space(.) != '']">
          ...
          <div class="md-itemshow">
            <xsl:for-each select="elemcls[normalize-space(.) != '']">
              <div class="md-item">
                <xsl:value-of select="position()" />
                <xsl:text>. </xsl:text>Network element</div>
              <div class="md-itemhide">
            ...
            <div class="md-detail">
              <div class="md-detailtitle">
                <xsl:for-each select="enttyp/enttypl[normalize-space(.) != '']">			
								Attributes of <xsl:value-of select="." /></xsl:for-each>
              </div>
            </div>
            <div class="md-detailhide">
    ...
    <xsl:for-each select="/metadata/eainfo/detailed[normalize-space(.) != '']">
      ...
      <xsl:if test="subtype[normalize-space(.) != '']">
        <div class="md-detail">
          <div class="md-detailtitle">
            <xsl:for-each select="enttyp/enttypl[normalize-space(.) != '']">		
						ESRI Subtypes of <xsl:value-of select="." /></xsl:for-each>
          </div>
        </div>
        <div class="md-detailhide">
    ...
    <div class="md-indent">
      ...
      <xsl:for-each select="relcomp[normalize-space(.) != '']">
        <xsl:choose>
          <xsl:when test=". = 'TRUE'">
            <div class="md">
              <b>Type of relationship: </b>Composite</div>
          </xsl:when>
          <xsl:otherwise>
            <div class="md">
              <b>Type of relationship: </b>Simple</div>
          </xsl:otherwise>
        </xsl:choose>
      </xsl:for-each>
  ...
  <xsl:template name="metadata_fgdc_plus_stylesheet">
    ...
    <div class="md-detailhelp">
      <div class="md">
        <b>Stylesheet: </b>FGDC Plus Stylesheet</div>
      <div class="md">
        <b>File name: </b>FGDC Plus.xsl</div>
      <div class="md">
        <b>Version: </b>2.0 </div>
      <div class="md">
...
The Biological Data Profile broadens the application of the CSDGM so that it is more easily applied to biological data that are not explicitly geographic (laboratory results, field notes, specimen collections, research reports) but can be associated with a geographic location. Includes taxonomical vocabulary. The Shoreline Data Profile addresses variability in the definition and mapping of shorelines by providing a standardized set of terms and data elements required to support metadata for shoreline and coastal data sets. The FGDC Plus Stylesheet includes the <a target="viewer" href="http://dublincore.org/">Dublin Core Metadata Element Set</a>. It supports W3C DOM compatible browsers such as IE7, IE6, Netscape 7, and Mozilla Firefox. It is in the public domain and may be freely used, modified, and redistributed. It is provided "AS-IS" without warranty or technical support.</div>
      ...
      <div class="md">
        <b>Download: </b>FGDC Plus Stylesheet is available from the ArcScripts downloads at <a target="viewer" href="http://www.esri.com">www.esri.com</a>.</div>
    </div>
  </xsl:template>
  ...
  <xsl:template name="identification_data_set_g_polygon_point_info">
    <table class="md-grid">
      ...
      <xsl:for-each select="grngpoin[normalize-space(.) != '']">&gt;
				<tr><td><xsl:value-of select="position()" /></td><xsl:choose><xsl:when test="gringlat[normalize-space(.) != '']"><xsl:for-each select="gringlat[normalize-space(.) != '']"><td><xsl:value-of select="." /></td></xsl:for-each></xsl:when><xsl:otherwise><td>(not provided)</td></xsl:otherwise></xsl:choose><xsl:choose><xsl:when test="gringlon[normalize-space(.) != '']"><xsl:for-each select="gringlon[normalize-space(.) != '']"><td><xsl:value-of select="." /></td></xsl:for-each></xsl:when><xsl:otherwise><td>(not provided)</td></xsl:otherwise></xsl:choose></tr></xsl:for-each>
    </table>
  </xsl:template>
  <!-- Data source info -->
